...
def plot_line_bar(data_dict, figname, figsize, bar_width, legends_loc="best", y_nbins=None, hline=False):
    plt.close("all")
...
if __name__ == "__main__":
    ...
    for the_data_set in dataset:
        for the_func in func:
            ...
            print(figname)
            plot_line_bar(data_dict[the_data_set][the_func], "figures_nccl/"+figname, (11, 3.1), 0.3)
